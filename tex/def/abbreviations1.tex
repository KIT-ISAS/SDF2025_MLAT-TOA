...
\renewcommand\vec[1]{\underline{#1}} % vector
\newcommand\mat[1]{{\mathbf #1}} % matrix 
\newcommand\rvec[1]{\vec{\boldsymbol{#1}}} % random vector
\newcommand\rv[1]{{\boldsymbol{#1}}} % random variable
\newcommand\Cov[1]{\op{Cov}\braces{#1}} % covariance 
\newcommand\Var[1]{\op{Var}\braces{#1}} % variance
\newcommand\Std[1]{\op{Std}\braces{#1}} % standard deviation
\newcommand\E[1]{\op{E}\braces{#1}} % expectation value
\newcommand\EHat[1]{\hat{\op{E}}\braces{#1}} % expectation value with hat
\newcommand\Menge[1]{{\cal #1}} % set font
\newcommand\trace[1]{\op{trace}(#1)} % trace spur 
\newcommand{\half}{{\frac{1}{2}}} % 1/2 fraction half
\newcommand\dd{{\,\op{d}}} % "d" operator for integration
\newcommand\T{ ^\top } % Transpose 
\newcommand\op[1]{{\operatorfont{#1}}} % operatorfont
